---
title: "Week 3: Descriptive Analysis"
...
cluster_level_2015 <- readRDS("/home/student25/Documents/Projects/Essay/Cleaned/cluster_level_2015.rds")
cluster_level_2020 <- readRDS("/home/student25/Documents/Projects/Essay/Cleaned/cluster_level_2020.rds")
cluster_level_combined <- readRDS("/home/student25/Documents/Projects/Essay/Cleaned/cluster_level_combined.rds")
shape_2015 <- readRDS("/home/student25/Documents/Projects/Essay/Cleaned/shape_2015.rds")
shape_2020 <- readRDS("/home/student25/Documents/Projects/Essay/Cleaned/shape_2020.rds")
...
print(desc_table)
write.csv(desc_table, "/home/student25/Documents/Projects/Essay/Cleaned/descriptive_table.csv", row.names = FALSE)
```
...
p_wealth <- ggplot(wealth_all, aes(x = wealth, y = malaria_prev, 
  ...
  theme_minimal()
print(p_wealth)
ggsave("/home/student25/Documents/Projects/Essay/Figures/malaria_by_wealth.png", 
...
p_itn <- ggplot(itn_all, aes(x = wealth, y = itn_use_rate, 
  ...
  theme_minimal()
print(p_itn)
ggsave("/home/student25/Documents/Projects/Essay/Figures/itn_by_wealth.png", 
...
p_res <- ggplot(res_all, aes(x = residence, y = malaria_prev, fill = survey)) +
  ...
  theme_minimal()
print(p_res)
ggsave("/home/student25/Documents/Projects/Essay/Figures/malaria_by_residence.png", 
...
p_age <- ggplot(age_all, aes(x = age_group, y = malaria_prev, 
  ...
  theme_minimal()
print(p_age)
ggsave("/home/student25/Documents/Projects/Essay/Figures/malaria_by_age.png", 
...
p_age_itn <- ggplot(itn_age_all, aes(x = age_group, y = itn_use_rate, 
  ...
  theme_minimal()
print(p_age_itn)
ggsave("/home/student25/Documents/Projects/Essay/Figures/itn_by_age.png", 
...
ggsave("/home/student25/Documents/Projects/Essay/Figures/malaria_map_2015.png", 
       map_2015, width = 10, height = 8)
ggsave("/home/student25/Documents/Projects/Essay/Figures/malaria_map_2020.png", 
...
ggsave("/home/student25/Documents/Projects/Essay/Figures/itn_map_2015.png", 
       map_itn_2015, width = 10, height = 8)
ggsave("/home/student25/Documents/Projects/Essay/Figures/itn_map_2020.png", 
...
```{r}
saveRDS(desc_table, "/home/student25/Documents/Projects/Essay/Cleaned/descriptive_summary.rds")
saveRDS(wealth_all, "/home/student25/Documents/Projects/Essay/Cleaned/wealth_analysis.rds")
saveRDS(age_all, "/home/student25/Documents/Projects/Essay/Cleaned/age_analysis.rds")
saveRDS(res_all, "/home/student25/Documents/Projects/Essay/Cleaned/residence_analysis.rds")
saveRDS(env_summary, "/home/student25/Documents/Projects/Essay/Cleaned/environmental_summary.rds")

write.csv(desc_table, "/home/student25/Documents/Projects/Essay/Cleaned/descriptive_summary.csv", row.names = FALSE)
write.csv(wealth_all, "/home/student25/Documents/Projects/Essay/Cleaned/wealth_analysis.csv", row.names = FALSE)
write.csv(age_all, "/home/student25/Documents/Projects/Essay/Cleaned/age_analysis.csv", row.names = FALSE)
